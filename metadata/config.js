...
module.exports = {
  ...
  examples: [
    ...
    { args: 'credentials http://wikibase.svc', comment: 'get the credentials for an instance' },
    { args: 'credentials http://wikibase.svc reset', comment: 'reset the credentials for an instance' },
