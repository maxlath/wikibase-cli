...
## 20.1.0 - 2026-02-11
* [`wb graph-path`](https://github.com/maxlath/wikibase-cli/blob/main/docs/read_operations.md#wb-graph-path): added `--format=mermaid` option (See mermaid graph format)
