...
program.process = (command) => {
  ...
  fallbackToConfigOption(program, 'clipboard')
  fallbackToConfigOption(program, 'json')
  fallbackToConfigOption(program, 'verbose')
}

function fallbackToConfigOption (program, parameter) {
