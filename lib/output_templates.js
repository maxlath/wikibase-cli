...
module.exports = ({ batchMode, format, propsToPick, requestedPropsAndSubProps }) => {
  const formatEntity = FormatEntity(batchMode, propsToPick, requestedPropsAndSubProps)
...
const FormatEntity = (batchMode, propsToPick, requestedPropsAndSubProps) => entity => {
