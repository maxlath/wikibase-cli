...
const getTokenOrRetry = async ({ instance, credentials }) => {
  try {
    validateInstanceCredentials({ instance, credentials })
    saveSuccessfulCredentials({ instance, credentials })
  } catch (err) {
...
const saveSuccessfulCredentials = ({ instance, credentials: instanceCreds }) => {
