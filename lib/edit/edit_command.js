...
async function runEditCommand (section, action, args) {
  [ section, action ] = renameAliasFunction(section, action)
  if (program.dry) {
...
function renameAliasFunction (section, action) {
  if (section === 'claim' && action === 'add') return [ 'claim', 'create' ]
  if (section === 'qualifier' && action === 'add') return [ 'qualifier', 'set' ]
  if (section === 'reference' && action === 'add') return [ 'reference', 'set' ]
